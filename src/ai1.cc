...
void AI1::makeMove() {
	...
	while(cin >> canMove) {
		...
		Coord randVal = *et;
		#ifdef DEBUG
		cout << "Random end Coord is: " << randVal.getX() << " " << randVal.getY() << endl;	
		#endif
		...
		else if (canMove == "resign") { gb->setResigned(true); break; }
		else { cerr << "Invalid input request, please enter either move or resign" << endl; }
	}
}
